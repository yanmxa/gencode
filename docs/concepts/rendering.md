...
| Compact / progress / plan | [`internal/app/conv/compact.go`](../../internal/app/conv/compact.go), [`progress.go`](../../internal/app/conv/progress.go), [`plan_view.go`](../../internal/app/conv/plan_view.go) |
