// Package openai_compat provides shared helpers for OpenAI-compatible providers
...
// ConvertTools converts generic provider.Tool schemas to OpenAI SDK tool params.
func ConvertTools(tools []provider.Tool) []openai.ChatCompletionToolUnionParam {
