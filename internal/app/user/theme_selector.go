...
var (
	...
	themeActiveStyle = lipgloss.NewStyle().Bold(true).Foreground(kit.CurrentTheme.Primary)
	themeItemStyle   = lipgloss.NewStyle().Foreground(kit.CurrentTheme.Text)
	themeDescStyle   = lipgloss.NewStyle().Foreground(kit.CurrentTheme.TextDim)
	themeHintStyle   = lipgloss.NewStyle().Foreground(kit.CurrentTheme.TextDim).MarginTop(1)
)
