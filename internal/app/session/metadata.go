...
func TranscriptFromSnapshot(sess *Snapshot, nodes []transcriptstore.Node, tasks []tool.TodoTask) transcriptstore.Transcript {
	return transcriptstore.Transcript{
		...
		State: transcriptstore.State{
			...
			Tasks:      transcriptstore.TodoTaskViewsFromTasks(tasks),
		},
	}
}
